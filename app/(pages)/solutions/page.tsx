...
const capabilities = [
  {
    ...
    img: "https://placehold.co/600x400/1a3a4a/e8f4f4?text=Diagnostic+Systems",
  },
  {
    icon: Droplets,
    ...
    img: "https://placehold.co/600x400/2b6b6b/e8f4f4?text=Blood+Analysers",
  },
  {
    icon: Scan,
    ...
    img: "https://placehold.co/600x400/0f2730/d5ebeb?text=X-ray+%26+Ultrasound",
  },
  {
    icon: FlaskConical,
    title: "Rapid Testing",
    ...
    img: "https://placehold.co/600x400/e63946/ffffff?text=Rapid+Testing",
  },
  {
    icon: Scissors,
    ...
    img: "https://placehold.co/600x400/4a5a60/e8f4f4?text=Surgical+Instruments",
  },
  {
    icon: Thermometer,
    ...
    img: "https://placehold.co/600x400/2b6b6b/ffffff?text=Sterilisation",
  },
  {
    icon: Armchair,
    ...
    img: "https://placehold.co/600x400/1a3a4a/d5ebeb?text=Clinic+Furniture",
  },
  {
    icon: Wrench,
    ...
    img: "https://placehold.co/600x400/9aa5ab/1a3a4a?text=Specialised+Equipment",
  },
];
    ...
    <>
      ...
      <div className="page-hero">
        <svg viewBox="0 0 24 24" fill="rgba(255,255,255,0.04)" width={150} height={150}
          className="page-hero-paw" style={{ top: "-20px", right: "40px", transform: "rotate(25deg)" }}
          aria-hidden="true">
          <path d={PAW_PATH} />
        </svg>
